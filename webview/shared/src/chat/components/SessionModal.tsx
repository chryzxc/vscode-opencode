...
export function SessionModal({ isOpen, onClose }: SessionModalProps) {
  ...
  const modalContent = (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/55 p-4 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      {/* Modal panel */}
      <div
        className="relative z-50 w-full max-w-md flex-col overflow-hidden rounded-xl border border-oc-border bg-oc-panel text-foreground shadow-2xl animate-in zoom-in-95 duration-200 max-h-[80vh]"
        role="dialog"
        aria-modal="true"
        aria-label="Sessions"
      >
